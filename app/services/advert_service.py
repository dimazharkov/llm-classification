...
class AdvertService:
    ...
    def summarize(self, source_path: str, target_path: str, llm: LLMClient, rate_limit=0.5) -> None:
        raw = load_from_disc(source_path)
    ...
    def analyze_results(self, source_path: str, rejected_path: str):
        ...
        prediction_list = [PredictedCategory.model_validate(prediction) for prediction in experiment_results]
