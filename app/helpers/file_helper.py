...
def csv_to_json(csv_path: str, json_path: str) -> list:
    ...
    fieldnames = ["category_parent_id", "category_parent_title", "category_id", "category_title", "advert_title", "advert_text"]
    ...
    needed_keys = ["parent_title", "parent_id", "category_title", "category_id", "title", "text"]
...
def read_json(json_path: str | Path) -> dict | list | None:
