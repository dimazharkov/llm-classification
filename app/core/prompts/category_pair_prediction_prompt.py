category_pair_prediction_prompt = (
    ...
    "Описание различий:\n{difference}\n\n"
    "Категория «{category1.title}» характеризуется ключевыми словами: {category1.tf_idf}.\n"
    "Категория «{category2.title}» характеризуется ключевыми словами: {category2.tf_idf}.\n"
