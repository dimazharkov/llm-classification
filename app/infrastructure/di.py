...
class Container(containers.DeclarativeContainer):
    ...
    experiment_one = providers.Factory(
        ExperimentOneUseCase,
        llm=llm_client,
        category_repo=category_file_repo
    )

    experiment_two = providers.Factory(
        ExperimentTwoUseCase,
        llm=llm_client,
        category_repo=category_file_repo
    )
    ...
    pairwise_classification_use_case = providers.Factory(
        ...
        llm=llm_client,
        category_evaluator=category_confidence_evaluator
    )
