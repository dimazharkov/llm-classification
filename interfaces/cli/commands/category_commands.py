...
from interfaces.cli.handlers.category_handlers import category_preprocess, category_compare, category_enrich
...
def preprocess(
    ...
    selected_ids: list[int] = typer.Option(SELECTED_IDS, help="Список ID категорий, например: 11239 11243 595",
    )
):
    category_preprocess(
...
def pair_description(
    ...
    category_compare(
        adverts_path, categories_path, category_pairs_path
    )
