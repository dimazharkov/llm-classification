...
class CategoryDifference(PromptStrategy[dict[str, Any], str]):
    ...
    def build_prompt(self, ctx: dict[str, Any]) -> str:
        return (
            ...
            f"- Keywords: {ctx['category1']['tf_idf_str']}\n"
            f"Category **{ctx['category2']['title']}**:\n"
            f"- Keywords: {ctx['category2']['tf_idf_str']}\n"
            ...
            "Ignore toponyms and service words (e.g. price/ціна, delivery/доставка, phone/телефон, photo/фото, used/б/у, new/нове, etc.). "
